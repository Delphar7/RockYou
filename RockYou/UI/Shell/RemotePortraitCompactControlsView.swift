...
///
/// This is the "surface" portion of the old `RemotePortraitCompactLayoutView`, but with:
...
/// - `RockYou/UI/RemotePortraitCompactLayoutView.swift` (the old composite owner)
@MainActor
